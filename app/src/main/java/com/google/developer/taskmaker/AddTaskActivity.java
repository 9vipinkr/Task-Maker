...
public class AddTaskActivity extends AppCompatActivity implements
    ...
    public static final String ADD_TASK_DUE_DATE="add_task_due_date";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            if (savedInstanceState.containsKey(ADD_TASK_DUE_DATE)) {
                setDateSelection(savedInstanceState.getLong(ADD_TASK_DUE_DATE));
            }
        }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        // save date selection for configuration changes
        outState.putLong(ADD_TASK_DUE_DATE,getDateSelection());
    }
